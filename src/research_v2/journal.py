...
def build_journal_prompt_summary(
    ...
    from research_v2.journal_prompt_builder import build_journal_prompt_summary_impl

    return build_journal_prompt_summary_impl(
        entries,
        limit=limit,
        journal_path=journal_path,
        prompt_compact=prompt_compact,
        current_score_regime=current_score_regime,
        current_iteration=current_iteration,
